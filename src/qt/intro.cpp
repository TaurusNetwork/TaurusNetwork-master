...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TaurusNetwork Core"),
     ...
     * override -datadir in the taurusnetwork.conf file in the default data directory
     * (to be consistent with taurusnetworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
