...
/** Utility functions used by the TAN Qt UI.
 */
namespace GUIUtil
{
...
// Render TAN addresses in monospace font
...
// Parse "taurusnetwork:" URI into recipient object, return true on successful parsing
