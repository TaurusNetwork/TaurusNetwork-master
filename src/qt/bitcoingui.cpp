                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TaurusNetwork-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TaurusNetwork address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and taurusnetwork: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TaurusNetwork Core"), this);
    aboutAction->setStatusTip(tr("Show information about TaurusNetwork Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TaurusNetwork"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TaurusNetwork addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TaurusNetwork addresses"));
    ...
    openAction->setStatusTip(tr("Open a TaurusNetwork: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TaurusNetwork Core help message to get a list with possible TaurusNetwork command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TaurusNetwork Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TaurusNetwork network", "", count));
}
...
{
    QString strTitle = tr("TaurusNetwork Core"); // default title
