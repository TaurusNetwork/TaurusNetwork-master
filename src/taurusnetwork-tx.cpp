...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TaurusNetwork Core taurusnetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  taurusnetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded taurusnetwork transaction") + "\n" +
                               "  taurusnetwork-tx [options] -create [commands]   " + _("Create hex-encoded taurusnetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded taurusnetwork transaction
