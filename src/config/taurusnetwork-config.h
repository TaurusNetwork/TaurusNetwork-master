/* src/config/taurusnetwork-config.h.  Generated from taurusnetwork-config.h.in by configure.  */
/* src/config/taurusnetwork-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://taurusnetwork.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TaurusNetwork Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TaurusNetwork Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "taurusnetwork"
