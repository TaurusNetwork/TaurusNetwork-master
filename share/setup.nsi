...
VIAddVersionKey ProductName "TaurusNetwork Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-taurusnetwork executable and locales:
    Delete /REBOOTOK $INSTDIR\taurusnetwork.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\taurusnetwork-qt.exe
    ...
    WriteRegStr HKCR "taurusnetwork" "URL Protocol" ""
    WriteRegStr HKCR "taurusnetwork" "" "URL:TAN"
    WriteRegStr HKCR "taurusnetwork\DefaultIcon" "" $INSTDIR\taurusnetwork-qt.exe
    WriteRegStr HKCR "taurusnetwork\shell\open\command" "" '"$INSTDIR\taurusnetwork-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\taurusnetwork-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\TAN.lnk"
    ...
    DeleteRegKey HKCR "taurusnetwork"
